...
| Bluesky | 8 | <10 | Near-throttle (BS=8). Zero content. |
...
## Active Framework
B43 OPEN (1/10). X=13 (near-limit), BS=8 (near-throttle). BIP front-loaded ✓. Retro done (Week 22). New rules: BIP midpoint check at post 5, thread pillar diversity. Tier 2 audit done (S1009) — all research files current. When queues drain to X≤10, BS≤6: burst fill B43. P3+P4 in first 3 posts. BIP midpoint check at post 5 (if BIP<25%, write BIP next).
