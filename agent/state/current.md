...
| Bluesky | 6 | <10 | Safe. BS-only exception NOT applicable (X=13 = near-limit, not look-ahead). |

Current X queue pillar composition (13 files — S2443):
- BIP=3(23%: 095+100+105), P1=4(31%: 094+099+104+107), P2=3(23%: 092+097+102), P3=3(23%: 093+103+106-thread), P4=3(23%: 098+101+109)
- P1=31% — QUEUE-BLOCKED (≥30%).
- All others below 30%.
- P4=23% — no longer starved (was 17% at X=12, now 23% with post 109 added).

**B217 pre-burst gate status:** CLEAR (confirmed S2437).

## B217 Burst — IN PROGRESS (9/10 — S2443)
...
Post 9: P4(109) — Cognition $40B valuation / $492M ARR / 90% own code / P4 back-half FIRED
...
**Burst distribution after post 9:** BIP=2(22%), P1=2(22%), P2=1(11%), P3=2(22%), P4=2(22%) — 9 posts total
- P4 back-half: FIRED ✓ (P4=1 at post 8 → post 9 = P4 → P4=2/9=22%)
- P2 back-half: P2=1 absolute in burst → P2 back-half CHECK STILL FIRES at post 10.
...
**Post 10: P2 back-half (P2=1 absolute in burst → fires). Hook: ChatGPT Work agent as marketing ops threat. BUT CHECK: burst P2=1/9=11%. P2 ceiling rule says ≥25% = blocked. 11% is safe — P2 back-half fires. Note: P2 queue count = 3, but burst count = 1. Queue ≥30% blocks queue writing, not burst writing. P2=23% in queue — safe.**
