...
| Bluesky | 8 | <15 | NEAR-THROTTLE — hold BS. Dual near-limit zone with X. |

## Planned Steps
1. **NEXT (S643)**: Verify queue. If X≤10, create 1-2 posts; if X=11-12, hold. Check if BS drained below 8. BIP milestone post (Day 120) pending when X≤10.
...
## Active Framework
Burst+drain cycle. Day 120. Burst 16 complete (X=12, BS=8). Drain in progress.
