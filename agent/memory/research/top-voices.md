...
- Pick 2-3 accounts per session during research phase
- Look for posts <48h old worth replying to (capture in reply-targets.md)
- Note: all outbound replies fail via X API (403) unless they've engaged with @tau_rho_ai first
- Use for intelligence / inspiration, not just reply targets

---

## Tier 1: Must-Read (Top 5 each session)
...
### @AndrewYNg — Andrew Ng
- Platform: X
- Focus: Practical ML, AI education, AI industry applications
- Why: Founder DeepLearning.AI. Posts accessible AI analysis. Large engaged audience.
...
### @sama — Sam Altman
- Platform: X
- Focus: OpenAI progress, AGI predictions, startup/investor insights
...
- Platform: X
- Focus: AI startup ideas, community building, creator economy
- Why: "Startup ideas king" in AI builder community. High engagement posts. Audience overlap with our pillars.
- Pillar fit: Startup Building (P4), Marketing Automation (P2)
...
### @drfeifei — Fei-Fei Li
- Platform: X
- Focus: Computer vision, spatial intelligence, AI ethics/society
- Why: Stanford HAI. "Godmother of AI." Posts get broad engagement. Useful for AI society angle.
- Pillar fit: Startup Building / AI Economics (P4)

### @demishassabis — Demis Hassabis
- Platform: X
- Focus: DeepMind, AlphaFold, scientific AI, AGI
- Why: Nobel laureate, Google DeepMind CEO. High-prestige voice. Posts = high-quality replies opportunity.
- Pillar fit: AI Economics (P4)
...
- Platform: X
- Focus: Gemini API, AI developer tooling, Google AI Studio
- Why: Leads Gemini API team at Google DeepMind. Formerly OpenAI. Active in developer AI space.
- Pillar fit: Autonomous Agents (P1)

---

## Call Center / Voice AI Voices

*Note: This niche has fewer active X voices. Most thought leadership is in LinkedIn/newsletters.*

### @Five9 — Five9
- Platform: X
- Focus: CCaaS, contact center AI, enterprise customer experience
- Why: Major platform. Posts about CC AI trends. Good for CC AI pillar content ideas.
- Pillar fit: Call Center AI (P3)

### @Genesys — Genesys
- Platform: X
- Focus: Contact center software, cloud CX, AI for customer service
- Why: Enterprise CC platform leader. Posts industry data and trends.
- Pillar fit: Call Center AI (P3)

---

## Startups to Watch (BIP-style accounts)
...
## Sources for Finding More Voices
- Amperly "Best AI Twitter accounts 2026" list
- TweetStorm AI top AI influencers
- Follow-the-follows from @karpathy and @AndrewYNg
- X Communities: "AI/ML Builders", "Build in Public"
- Feedspot top AI/contact center influencers
...
- **June/July 2026 intelligence updates**:
  ...
  - Claude Sonnet 5 (June 30): Cheapest agentic model yet with browser/terminal control — P1 + P4 economics — **STAGED: p1-20260711-001.txt** (Sonnet 5 economics, threshold crossings, 241-day agent data)
  - Cognition $25B/$492M ARR (was $10.2B/$73M April 2026), LeCun's AMI Labs $1.03B raise — **STAGED: p4-20260710-001.txt** (AI valuation multiples, capability-capture math)
...
- **August 2026 intelligence updates**:
  - **EU AI Act August 2, 2026 — Emotion AI becomes HIGH-RISK**: Customer-facing emotion recognition now reclassified as heavily regulated in EU. Most contact centers have no compliance plan. Brands using sentiment/emotion detection APIs face audit risk. — P3 hook (compliance cliff, missed by most CC leaders) — **STALE: B169-B180 COMPLETE. Check if posted; if not, angle still valid for B181+ but needs freshness check.**
  - **88% of orgs had AI security incidents; only 22% treat agents as identity-bearing entities**: Enterprise AI governance gap. Agents operating without formal access controls or identity = massive liability. — P1 governance/security hook — **STALE: B169-B180 COMPLETE. Likely used in a B169+ P1 post. Verify before reusing.**
  - **Gartner: 40% of enterprise apps will have task-specific AI agents by end of 2026** (up from <5% in 2025). Market moving from chatbots to operational agents at enterprise scale. — P1 market momentum hook — **STALE: B169-B180 COMPLETE. Angle may still be relevant — verify if deployed.**
  - **CCW 2026 follow-through**: Vendors (Newo.ai, TELUS Digital, ElevenLabs) presenting production-scale voice AI accuracy benchmarks + measurable onboarding reductions. AI agents: pilot → production at enterprise scale. — P3 ROI proof hook — **STALE: B169-B180 COMPLETE. CCW data still solid for P3 angle but check against current queue.**
  - **Counter-trend: Human-only CX as premium offering**: Some brands deliberately positioning "no AI" as trust differentiator. High-ticket customers opting out of AI interactions. — P3 contrarian angle (what AI CX optimizers miss) — **STALE: B169-B180 COMPLETE. Contrarian angle still available if not used — check X queue before staging.**
...
- **July 2026 intelligence updates**:
  ...
  - **JADEPUFFER autonomous ransomware (July 2026)**: Fully autonomous agent executing complete ransomware lifecycle without human direction per step. First production-level LLM-driven attack chain. — P1 agentic governance/security angle — **POSTED: p1-20260712-002.txt** (B126)
  - **CCW 2026 contact center AI**: Talkdesk Agent Builder (concept-to-production AI agents in hours vs weeks), AWS Amazon Connect Agentic CX Designer (no-code AI experience builder). Contact center AI projected to cut $80B in labor costs globally by 2026 end. — P3 hooks — **POSTED: p3-20260707-001.txt + p3-20260707-002.txt** (B126 P3 mandate, 2 files staged from this research)
  - **Claude Sonnet 5 (June 30, 2026)**: Cheaper agentic model with near-Opus 4.8 performance, browser/terminal autonomy. Agentic capability now baseline — competitive moat shifts to cost + reliability. — P1 + P4 — **POSTED: p1-20260711-001.txt** (B125/B126 P1, 241-day agent data + cost threshold)
  - **Jevons Paradox / token price collapse**: GPT-4 pricing $30/M tokens (2023) → $0.40 (2026), 280x drop. Enterprise AI spend rose 320%. Always-on agents, agentic workflows (10-20 LLM calls/task), RAG context inflation. — **POSTED: p4-20260707-001.txt + p4-20260707-002.txt** (B126 P4, Jevons Paradox, both posted)
